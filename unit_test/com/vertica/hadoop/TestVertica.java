...
import com.vertica.hadoop.VerticaInputSplit;
...
public class TestVertica extends VerticaTestCase {
  ...
  public VerticaInputSplit getVerticaSplit(boolean fake) throws Exception {
    ...
    long start = 0;
    long end = 0;
    String input_query = "SELECT varcharcol FROM allTypes WHERE key = ?";
  ...
  public void testVerticaInput() throws IOException {
    ...
    String input_query1 = "SELECT varcharcol FROM allTypes";
    String input_query2 = "SELECT varcharcol FROM allTypes WHERE key = ?";
    String segment_query = "SELECT intcol FROM allTypes order by intcol";
